...
function initRuntimeSocketService() {
  const hosts = "10.20.42.3,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_pwSKyf";
...
const globalStyle = new UTSJSONObject({
  ...
  navigationBarTitleText: "EEnous Technology",
...
const b = true, k = "mp-weixin", E = T(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), A = k, P = T('{"address":["127.0.0.1","10.20.42.3"],"servePort":7000,"debugPort":9000,"initialLaunchType":"remote","skipFiles":["<node_internals>/**","E:/table/APE/HBuilderX.4.45.2025010502/HBuilderX/plugins/unicloud/**/*.js"]}'), C = T('[{"provider":"aliyun","spaceName":"scancode","spaceId":"mp-927edb95-f54c-475f-8b66-47b360765fae","clientSecret":"Q9zrYhOJnp6huC2h2LfWBw==","endpoint":"https://api.next.bspapp.com"}]') || [];
let x = "";
try {
  x = "__UNI__D740E63";
} catch (e2) {
